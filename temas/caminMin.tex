...
Es un poco m\'as lento que el algoritmo de Dijkstra, pero admite ejes de pesos negativos. Al igual que el algoritmo de Dijkstra, utiliza el principio de relaxation para ir mejorando continuamente las aproximaciones a las mejores distancias de cada v\'ertice.
